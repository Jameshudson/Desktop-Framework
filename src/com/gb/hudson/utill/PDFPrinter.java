...
public class PDFPrinter{
	...
	public int addPdfToPrintList(PDFPageable pdf){
		
		this.pdfPrintList.add(pdf);

		return this.pdfPrintList.size() -1;
	}

	public boolean movePdf(int place, PDFPageable pdf){

		if(place >= 0 && place < pdfPrintList.size() && pdf != null){

			pdfPrintList.remove(pdf);

			pdfPrintList.add(place, pdf);
	...
	public PDFPageable getPDF(int place){
		return pdfPrintList.get(place);
	}
